...
/// (https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/contracts/utils/cryptography/P256.sol) @dev
/// Optimized for a balance between runtime gas and bytecode size.
