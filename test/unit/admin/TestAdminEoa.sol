...
contract TestAdminEoa is Helpers {
    using KeyLib for *;
    ...
    function test_admin_eoa_add_signer_direct() external {
    ...
    function test_admin_eoa_add_signer_aa_mode_00() external {
        random = _createKeySecp256k1(TypeOfKey.SIGNER, randomEoa);
        expected.push(random);
    ...
    function test_admin_eoa_add_signer_aa_mode_01() external {
        random = _createKeySecp256k1(TypeOfKey.SIGNER, randomEoa);
        expected.push(random);
    ...
    function test_admin_eoa_deposit_direct() external {
        _deposit();
        _assertDeposit();
    }

    function test_admin_eoa_deposit_aa_mode_00() external {
    ...
    function test_admin_eoa_deposit_aa_mode_01() external {
        bytes memory dataApprove =
            abi.encodeWithSelector(IERC20.approve.selector, address(paymaster), type(uint256).max);
    ...
    function test_admin_eoa_add_stake_direct() external {
        _stake();
        _assertStaked();
    }

    function test_admin_eoa_add_stake_aa_mode_00() external {
        calls.push(
            _encodeCall(
                address(paymaster),
                Constants.ETH_0_1,
    ...
    function test_admin_eoa_add_stake_aa_mode_01() external {
        bytes memory dataApprove =
            abi.encodeWithSelector(IERC20.approve.selector, address(paymaster), type(uint256).max);
    ...
    function test_admin_eoa_unlock_stake_direct() external {
        _stake();
        _assertStaked();
    ...
    function test_admin_eoa_unlock_stake_aa_mode_00() external {
        _stake();
        _assertStaked();
    ...
    function test_admin_eoa_unlock_stake_aa_mode_01() external {
        _stake();
        _assertStaked();
