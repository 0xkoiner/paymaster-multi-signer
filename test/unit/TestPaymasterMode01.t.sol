...
contract TestPaymasterMode01 is Helpers {
    ...
    // Test ERC20_MODE with any bundler
    function test_paymaster_entry_point_mode_1_all_bundlers_p256_extr_signer() external {
        prehash = false;
        (PackedUserOperation[] memory u, bytes32 userOpHash) =
            _getUserOp(__7702_ADDRESS_EOA, __7702_EOA, hex"", Sponsor_Type.ERC20, Allow_Bundlers.ALL, SignerType.P256);
    ...
    // Test ERC20_MODE with any bundler
    function test_paymaster_entry_point_mode_1_all_bundlers_p256_non_extr_signer() external {
        prehash = true;
        (PackedUserOperation[] memory u, bytes32 userOpHash) =
            _getUserOp(__7702_ADDRESS_EOA, __7702_EOA, hex"", Sponsor_Type.ERC20, Allow_Bundlers.ALL, SignerType.P256);
    ...
    // Test ERC20_MODE with specific bundler
    function test_paymaster_entry_point_mode_1_check_bundler_p256_extr_signer() external {
        prehash = false;

        (PackedUserOperation[] memory u, bytes32 userOpHash) = _getUserOp(
            __7702_ADDRESS_EOA, __7702_EOA, hex"", Sponsor_Type.ERC20, Allow_Bundlers.SPECIFIC, SignerType.P256
        );
    ...
    // Test ERC20_MODE with specific bundler
    function test_paymaster_entry_point_mode_1_check_bundler_p256_non_extr_signer() external {
        prehash = true;
    ...
    // Test ERC20_MODE with any bundler full cycle
    function test_paymaster_7702_account_mode_1_all_bundlers_p256_extr_signer() external {
        prehash = false;
        ...
        (PackedUserOperation[] memory u,) =
            _getUserOp(__7702_ADDRESS_EOA, __7702_EOA, data, Sponsor_Type.ERC20, Allow_Bundlers.ALL, SignerType.P256);
    ...
    // Test ERC20_MODE with any bundler full cycle
    function test_paymaster_7702_account_mode_1_all_bundlers_p256_non_extr_signer() external {
        prehash = false;
    ...
    // Test ERC20_MODE with specific bundler full cycle
    function test_paymaster_7702_account_mode_1_check_bundler_p256_extr_signer() external {
        prehash = false;
        ...
        (PackedUserOperation[] memory u,) = _getUserOp(
            __7702_ADDRESS_EOA, __7702_EOA, data, Sponsor_Type.ERC20, Allow_Bundlers.SPECIFIC, SignerType.P256
        );
    ...
    // Test ERC20_MODE with specific bundler full cycle
    function test_paymaster_7702_account_mode_1_check_bundler_p256_non_extr_signer() external {
        prehash = true;
    ...
    // Test ERC20_MODE with any bundler
    function test_paymaster_entry_point_mode_1_all_bundlers_webauthn_signer() external {
        (PackedUserOperation[] memory u, bytes32 userOpHash) = _getUserOp(
            __7702_ADDRESS_EOA, __7702_EOA, hex"", Sponsor_Type.ERC20, Allow_Bundlers.ALL, SignerType.WebAuthnP256
        );
    ...
    // Test ERC20_MODE with specific bundler
    function test_paymaster_entry_point_mode_1_check_bundler_webauthn_signer() external {
        (PackedUserOperation[] memory u, bytes32 userOpHash) = _getUserOp(
            __7702_ADDRESS_EOA, __7702_EOA, hex"", Sponsor_Type.ERC20, Allow_Bundlers.SPECIFIC, SignerType.WebAuthnP256
        );
    ...
    // Test ERC20_MODE with any bundler full cycle
    function test_paymaster_7702_account_mode_1_all_bundlers_webauthn_signer() external {
        _assert(true, 0);
        _assertErc20(true, address(sponsorERC20), __PAYMASTER_SUPER_ADMIN_ADDRESS_EOA);
        ...
        (PackedUserOperation[] memory u,) = _getUserOp(
            __7702_ADDRESS_EOA, __7702_EOA, data, Sponsor_Type.ERC20, Allow_Bundlers.ALL, SignerType.WebAuthnP256
        );
    ...
    // Test ERC20_MODE with specific bundler full cycle
    function test_paymaster_7702_account_mode_1_check_bundler_webauthn_signer() external {
        _assert(true, 0);
        _assertErc20(true, address(sponsorERC20), __PAYMASTER_SUPER_ADMIN_ADDRESS_EOA);
        ...
        (PackedUserOperation[] memory u,) = _getUserOp(
            __7702_ADDRESS_EOA, __7702_EOA, data, Sponsor_Type.ERC20, Allow_Bundlers.SPECIFIC, SignerType.WebAuthnP256
        );
